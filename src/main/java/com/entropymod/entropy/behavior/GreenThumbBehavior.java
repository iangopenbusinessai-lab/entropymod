 ...
 *
 * <p><b>Green Thumb contributes nothing to {@code cropGrowthMultiplier} any
 * more</b>, and this class deliberately no longer declares a multiplier constant
 * so it cannot be quietly re-wired into that hook and double-applied. Blight
 * Touched still uses that hook and is unaffected by the move.
 *
...
public final class GreenThumbBehavior extends HookEffectBehavior {
	 ...
	 * crop at the moment of its advance. Blight Touched shares this radius through
